...
<div style="margin-top:450px;width:800px;height:200px;margin-left: 20%;">
   <div style="position: relative;margin-top:20px"><center>
	<div id="Photo" style=" display: inline-block; border-radius: 50%;">
	<img src="http://140.117.68.56/web2017/B044012038/140.117.68.56/web2017/B044012038/final/andy.jpg">
    </div>
</center><br>
    <div id="Name" style="display: inline;font-size: 30px; ">
    <center><span id="name">Andy</span></center>
    </div>
    </div>
<br><br>
...
<br>
    <div id="DIV_01">
       ...
       <span id="w1">網頁設計</span>
       <span id="r2"><b>年級:</b></span>
       <span id="w2">高中以上</span>
       <span id="r3"><b>特色:</b></span>
       <span id="w3">勤奮認真</span>
    </div>
...
<div class="tab">
  ...
  <div style="font-size: 20px;margin-top: 10px;margin-left:400px">
 <a href="http://140.117.68.56/web2017/B044012038/140.117.68.56/web2017/B044012038/final/Cindy_blog.php">首頁</a></div>
</div>
...
<div id="T_ex">
    ...
    <span>網頁程式設計(html、php、javacript...)</span><br><br>
    <span><b>教學經驗:</b></span><br>

    <span>曾指導高二學生參加網頁設計比賽榮獲特優</span><br>
    <span>高雄大學學生能製作精美網頁</span>
    <br><br>
...
<div id="self_intro" class="tabcontent" style="word-break: break-all;">
  ...
  <p>各位家長、同學好，我是Andy，目前是資管大二的學生，自小就愛製作各種網頁，曾任國立中山大學Web程式設計的助教，並接過無數企業的網頁設計承包案。</p>
</div>

<div id="content" class="tabcontent" style="word-break: break-all;"">
 <h3>服務內容</h3>
  <HR color="lightgray" size="1" width="100%">
  <p>輔導網頁設計、製作，從不會學到會，分享業界秘辛</p>
</div>


<div id="essay" class="tabcontent">
 <h3>我的文章</h3>
<span style="word-break: break-all;">學校沒教的網頁設計課</span><br><br>
<span style="word-break: break-all;">看到別人的網頁驚嘆萬分，自己卻老是被人說沒有美感?八招教你攻略網頁美編，並擊倒各種可惡的設計bug!..............................</span><br>
 </div>
...
<script type="text/javascript">
    ...
    <script>
		...
		function gointo() {
			...
			newplace.innerHTML = '<div class="up1"><img src="http://140.117.68.56/web2017/B054020030/MISProject/images/andy.jpg"></div><div class="Right2">&nbsp<span class = "word1">'+word+'</span></div><div id="f'+count+'"><div id="second'+count+'"></div><div class="down1"><img src="http://140.117.68.56/web2017/B054020030/MISProject/images/andy.jpg"><input type="text" placeholder="  回覆......" autofocus autocomplete="off" id="text2'+count+'" class="com1"><input type="button" id="button2'+count+'" value="send" class="but" onclick="gointo1('+count+')"></div></div>'
		...
		function gointo1(good) {
			...
			newplace1.innerHTML = '<div class="up2"><img src="http://140.117.68.56/web2017/B054020030/MISProject/images/andy.jpg"></div><div class="Right3">&nbsp<span class = "word1">'+word1+'</span></div>'
	...
	<div class="up">
		...
		<div class="middle">
			<span style="word-break: break-all;">對於網頁設計有問題，都歡迎問我喔!
			</span>
		</div>
		<div class="Great">
       ...
       <span id="num"></span>
		...
		<div class="down"><img src="http://140.117.68.56/web2017/B054020030/MISProject/images/andy.jpg">			<input type="text" placeholder="  留言......" autofocus autocomplete="off" id="text1" class="com">
