...
<div style="margin-top:450px;width:800px;height:200px;margin-left: 20%;">
   <div style="position: relative;margin-top:20px"><center>
	...
	<img src="http://140.117.68.56/web2017/B054020030/MISProject/images/namei.jpg">
    </div>
</center><br>
    <div id="Name" style="display: inline;font-size: 30px; ">
    <center><span id="name">Namei</span></center>
    </div>
    </div>
<br><br>
...
<br>
    ...
    <div id="DIV_03">
       ...
       <span id="w8">教師面對面函授</span>
       <span id="r9"><b>教材:</b></span>
       <span id="w9">自編講義及練習曲</span>
    </div>
...
<div class="tab">
 ...
 <a href="http://140.117.68.56/web2017/B054020030/MISProject/Namei_blog.php">首頁</a></div>
</div>
...
<div id="T_ex">
    ...
    <span>音樂(演奏與樂理)</span><br><br>
    <span><b>教學經驗:</b></span><br>

    <span>國三生榮獲全國小提琴首獎</span><br>
    <span>高中生樂理及家教亦可</span>
    <br><br>
...
<div id="self_intro" class="tabcontent" style="word-break: break-all;">
  ...
  <p>安安，我是Namei，是就讀音樂系大三的學生，小提琴是我從小以來的強項，是全國小提琴大賽的常勝軍
  ，曾任台大音樂班小提琴課的助教，日後期望能進入英國皇家海軍古典樂隊。</p>
</div>

<div id="content" class="tabcontent" style="word-break: break-all;"">
 <h3>服務內容</h3>
  <HR color="lightgray" size="1" width="100%">
  <p> 指導學生小提琴演奏及樂理，專業演奏及樂理兼顧，依學生程度調整教學內容</p>
</div>


<div id="essay" class="tabcontent">
 <h3>我的文章</h3>
<span style="word-break: break-all;">小提琴演奏技巧-樂理篇</span><br><br>
<span style="word-break: break-all;">關於小提琴演奏，最重要的莫過於熟習了！樂理可由書面習得，但小提琴的演奏技巧卻須每日熟習，才能日漸精進!!!! ..............................</span><br>
 </div>
...
<script type="text/javascript">
    ...
    <script>
		...
		function gointo() {
			...
			newplace.innerHTML = '<div class="up1"><img src="http://140.117.68.56/web2017/B054020030/MISProject/images/namei.jpg"></div><div class="Right2">&nbsp<span class = "word1">'+word+'</span></div><div id="f'+count+'"><div id="second'+count+'"></div><div class="down1"><img src="http://140.117.68.56/web2017/B054020030/MISProject/images/namei.jpg"><input type="text" placeholder="  回覆......" autofocus autocomplete="off" id="text2'+count+'" class="com1"><input type="button" id="button2'+count+'" value="send" class="but" onclick="gointo1('+count+')"></div></div>'
		...
		function gointo1(good) {
			...
			newplace1.innerHTML = '<div class="up2"><img src="http://140.117.68.56/web2017/B054020030/MISProject/images/namei.jpg"></div><div class="Right3">&nbsp<span class = "word1">'+word1+'</span></div>'
	...
	<div class="up">
		...
		<div class="middle">
			<span style="word-break: break-all;">歡迎大家一起進入古典樂的美妙世界~~~~~
			</span>
		</div>
		<div class="Great">
       ...
       <span id="num"></span>
		...
		<div class="down"><img src="http://140.117.68.56/web2017/B054020030/MISProject/images/namei.jpg">			<input type="text" placeholder="  留言......" autofocus autocomplete="off" id="text1" class="com">
