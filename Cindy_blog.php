...
<div style="margin-top:450px;width:800px;height:200px;margin-left: 20%;">
   <div style="position: relative;margin-top:20px"><center>
	...
	<img src="http://140.117.68.56/web2017/B044012038/140.117.68.56/web2017/B044012038/final/cindy.jpg">
    </div>
</center><br>
    <div id="Name" style="display: inline;font-size: 30px; ">
    <center><span id="name">Cindy</span></center>
    </div>
    </div>
<br><br>
...
<div id="T_ex">
    ...
    <span>appinventor程式設計</span><br><br>
    <span><b>教學經驗:</b></span><br>

    <span>曾指導小二寫簡易app</span><br>
    <span>使小六能於半年內獨立完成專案</span>
    <br><br>
...
<div id="self_intro" class="tabcontent" style="word-break: break-all;">
  ...
  <p>各位家長、同學好，我是Cindy，目前是資管大二的學生，自小就愛寫各種程式如:C、C++或Python等，也寫過幾個app，曾任國立中山大學Web程式設計的助教，立志能夠成為獨當一面的工程師。</p>
</div>

<div id="content" class="tabcontent" style="word-break: break-all;"">
 <h3>服務內容</h3>
  <HR color="lightgray" size="1" width="100%">
  <p> appinventor之app專案指導，程式邏輯訓練，培養學生程式邏輯與解決能力，並適當給予鼓勵</p>
</div>


<div id="essay" class="tabcontent">
 <h3>我的文章</h3>
<span style="word-break: break-all;">小學生也可以學程式?</span><br><br>
<span style="word-break: break-all;">千萬不要小看小學生的能力，小學生也能寫程式!若能提早開發邏輯思維，對日後學業、生活、工作上均有非常大的幫助。究竟我是怎麼教導小學生的呢?首先，我會設計許多小遊戲測試學生的程度，再替他們訂製量身打造的講義和課程..............................</span><br>
 </div>
...
<script type="text/javascript">
    ...
    <script>
		...
		function gointo() {
			...
			newplace.innerHTML = '<div class="up1"><img src="http://140.117.68.56/web2017/B054020030/MISProject/images/cindy.jpg"></div><div class="Right2">&nbsp<span class = "word1">'+word+'</span></div><div id="f'+count+'"><div id="second'+count+'"></div><div class="down1"><img src="http://140.117.68.56/web2017/B054020030/MISProject/images/cindy.jpg"><input type="text" placeholder="  回覆......" autofocus autocomplete="off" id="text2'+count+'" class="com1"><input type="button" id="button2'+count+'" value="send" class="but" onclick="gointo1('+count+')"></div></div>'
		...
		function gointo1(good) {
			...
			newplace1.innerHTML = '<div class="up2"><img src="http://140.117.68.56/web2017/B054020030/MISProject/images/cindy.jpg"></div><div class="Right3">&nbsp<span class = "word1">'+word1+'</span></div>'
	...
	<div class="up">
		...
		<div class="middle">
			<span style="word-break: break-all;">各位好，有任何問題都歡迎詢問!
			</span>
		</div>
		<div class="Great">
       ...
       <span id="num"></span>
		...
		<div class="down"><img src="http://140.117.68.56/web2017/B054020030/MISProject/images/cindy.jpg">			<input type="text" placeholder="  留言......" autofocus autocomplete="off" id="text1" class="com">
