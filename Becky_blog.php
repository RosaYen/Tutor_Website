...
<div style="margin-top:450px;width:800px;height:200px;margin-left: 20%;">
   <div style="position: relative;margin-top:20px"><center>
	...
	<img src="http://140.117.68.56/web2017/B044012038/140.117.68.56/web2017/B044012038/final/becky.jpg">
    </div>
</center><br>
    <div id="Name" style="display: inline;font-size: 30px; ">
    <center><span id="name">Becky</span></center>
    </div>
    </div>
<br><br>
...
<br>
    <div id="DIV_01">
       ...
       <span id="w2">高中、大學</span>
       <span id="r3"><b>特色:</b></span>
       <span id="w3">專攻數理</span>
    </div>
...
<div id="T_ex">
    ...
    <span>數學(微積分)</span><br><br>
    <span><b>教學經驗:</b></span><br>

    <span>高二學生段考進步二十分</span><br>
    <span>科大學生輔導微積分</span>
    <br><br>
...
<div id="self_intro" class="tabcontent" style="word-break: break-all;">
  ...
  <p>各位好，我是Becky，是就讀清華資工大三的學生，數理是我從小的強項，數學對我而言是很有趣的事物，曾任國立清華大學資料結構的助教，日後期望能進入竹科工作。</p>
</div>

<div id="content" class="tabcontent" style="word-break: break-all;"">
 <h3>服務內容</h3>
  <HR color="lightgray" size="1" width="100%">
  <p> 指導學生數學、理化，並協助訂定讀書計畫，從基礎往下紮根</p>
</div>


<div id="essay" class="tabcontent">
 <h3>我的文章</h3>
<span style="word-break: break-all;">如何正確有效率的學習數學</span><br><br>
<span style="word-break: break-all;">數學是許多人的痛處，這邊我要介紹幾個常見錯誤的學習數學方式，1. 死記公式 2.寫太多題目 3.太晚下筆 ..............................</span><br>
 </div>
...
<script type="text/javascript">
    ...
    <script>
		...
		function gointo() {
			...
			newplace.innerHTML = '<div class="up1"><img src="http://140.117.68.56/web2017/B054020030/MISProject/images/becky.jpg"></div><div class="Right2">&nbsp<span class = "word1">'+word+'</span></div><div id="f'+count+'"><div id="second'+count+'"></div><div class="down1"><img src="http://140.117.68.56/web2017/B054020030/MISProject/images/becky.jpg"><input type="text" placeholder="  回覆......" autofocus autocomplete="off" id="text2'+count+'" class="com1"><input type="button" id="button2'+count+'" value="send" class="but" onclick="gointo1('+count+')"></div></div>'
		...
		function gointo1(good) {
			...
			newplace1.innerHTML = '<div class="up2"><img src="http://140.117.68.56/web2017/B054020030/MISProject/images/becky.jpg"></div><div class="Right3">&nbsp<span class = "word1">'+word1+'</span></div>'
	...
	<div class="up">
		...
		<div class="middle">
			<span style="word-break: break-all;">數學總是學不會?來問我就對了!
			</span>
		</div>
		<div class="Great">
       ...
       <span id="num"></span>
		...
		<div class="down"><img src="http://140.117.68.56/web2017/B054020030/MISProject/images/becky.jpg">			<input type="text" placeholder="  留言......" autofocus autocomplete="off" id="text1" class="com">
