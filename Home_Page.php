		...
		<!-- Nav -->
			<nav id="menu">
				<ul class="links">
					...
					<li><a href="edit_Selfinfor.php">編輯個人資料/Edit Self-Information</a></li>
							...
							<!-- 2 Columns -->
								<div class="flex flex-2">
									...
									<div class="col col2">
										...
										<a href="submit_ft.html" class="button">找家教</a>
										<a href="submit_fs.html" class="button">找學生</a>
						...
						<div class="inner">
							<div class="flex flex-2">
								<div class="col col2">
									...
									<a href="blog_edit.php" class="button">GO!</a>
									<a href="#" class="button">TOP</a>
						...
						<div class="inner">
							...
							<div class="flex flex-3">
								<div class="col align-center">
									...
									<p>不限科目種類、不限年齡、任何人都能在這裡找到自己想要的老師/學生</p>
								...
								<div class="col align-center">
									...
									<p>想找高薪打工、學校附近就有家教案件急徵老師！ 伴讀、免經驗、短期家教， 家教新手也能輕鬆上手～</p>
									<a href="#" class="button">Learn More</a>
								</div>
								<div class="col align-center">
									<div class="image round fit">
									...
									<p>無論是考前衝刺、伴讀、數理、英文、音樂、才藝、運動等，上萬優秀師資都能幫你大改造
家長推薦，好老師輕鬆找 · 免刊登費</p>
									<a href="#" class="button">Learn More</a>
								</div>
							</div>
		...
		<!-- Footer -->
			<footer id="footer">
				<div class="copyright">
					...
					<p>&copy; MIS_TUTOR. All rights reserved. Design: <a href="#">GROUP11</a>. Images: <a href="https://unsplash.com">Unsplash</a>.</p>
				</div>
			</footer>
